...
import { dataSponsor, dataMedpart } from "../../resources/dataMedPartSponsor";
    ...
    <div className="relative md:mt-4">
      ...
      <div className="relative bg-krem">
        ...
        <div className="pb-8 pt-36 md:px-24 px-4">
          <div
            className="relative bg-white bg-opacity-50 shadow-2xl pt-16 pb-12 px-8 rounded-20xl md:mb-12"
            style={{ border: "solid white 10px" }}
          >
            <h2 className="absolute md:-top-36 md:left-24 md:text-8xl -top-24 text-5xl font-nuku text-oren ml-10 md:ml-0">
              Sponsor
            </h2>
        ...
        <div className="pb-8 pt-36 md:px-24 px-4">
          <div
            className="relative shadow-2xl pt-16 pb-12 px-8 rounded-20xl bg-white  bg-opacity-50"
            style={{ border: "solid white 10px" }}
          >
            <h2 className="absolute mt-6 md:-top-48 md:left-24 md:text-8xl -top-48 text-5xl font-nuku text-abu mr-8 md:mr-0">
              Media Partner
            </h2>
