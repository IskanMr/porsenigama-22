...
const ReadMore = ({ children }) => {
  ...
  return (
    <p className="text">
      ...
      <span onClick={toggleReadMore} className="read-or-hide text-hyperlink cursor-pointer p-1 m-2 bg-white">
...
const Tentang = () => {
  return (
    <>
      <div className="z-30 relative mb-12">
        ...
        <div
          className="z-20 rounded-large w-4/5 md:w-3/4 mx-auto pb-5 md:pb-12"
        ...
        >
          ...
          <p className="text-justify px-8 text-sm md:text-xl font-montserrat md:hidden">
            <ReadMoreMobile>
              ...
              sebelum pandemi. Porsenigama 2022 mengusung tema “Bahtera
              Abhipraya” dengan slogan “Pijar Laskar Gadjah Mada, Cipta Gemilang
              Porsenigama” menjadi harapan baru untuk seluruh lapisan
              masyarakat. Dengan terbentangnya layar bahtera Porsenigama dalam
              mengarungi lautan samudera harapan, menjadi awal lahirnya cahaya
              baru bersatunya Laskar Gadjah Mada”. Bahtera Abhipraya juga
              menjadi manifestasi bagi para atlet dan seniman untuk memulai
              sebuah perjalanan bergerak dan berpadu untuk maju dengan membawa
              harapan besar dan bersama menerobos terpaan badai yang sedang
              dihadapi menuju tujuan akhir, tercapainya harapan dan kekuatan
        ...
        {/* <img
          src={Explode}
          className="right-0 xl:pr-20 -bottom-24 absolute hidden md:block z-0"
          alt=""
        /> */}
        <img
