...
const Standings = () => {
  ...
  const getAllMedals = async () => {
    const snap = await getDocs(
      query(collection(db, "standings"), orderBy("name"))
    );
  ...
  return (
    <>
      ...
      <div className="min-h-screen font-display tracking-widest relative overflow-hidden">
        ...
        <div className="bg-pattern-klasemen font-montserrat">
          <div className="flex justify-start px-8 md:px-32">
            <select
              id="filterli"
              className="dropdown absolute rounded-md pl-1 py-2 md:pl-2 justify-end max-w-xs mt-16 w-1/2 text-md xl:m-52 lg:m-40 lg:text-2xl xl:h-12 lg:h-10 sm:mt-20 md:ml-24 sm:text-md md:w-1/4 sm:w-1/4 sm:m-10 bg-gray-300 font-semibold z-40"
              onClick={optionClick}
            >
            ...
            <table className="text-xs lg:text-sm md:text-base xl:text-xl z-30 md:text-fivevh xl:mx-60 m-auto md:table-fixed md:w-full mt-4 md:mx-20 md:my-32 sm:mt-20">
              <thead>
                <tr>
                  ...
                  <th
                    className="lg:mx-5 lg:py-2 md:w-20 border-2 md:border-4 border-black"
                    align="center"
                  >
                    <img
                      src={MedaliEmas}
                  ...
                  <th
                    className="lg:mx-5 lg:py-2 border-2 md:border-4 md:w-20 border-black"
                    align="center"
                  >
                    <img
                      src={MedaliBronze}
                  ...
                  <th className="lg:px-45 lg:py-2 lg:mx-10 border-2 md:border-4 border-black text-xs lg:text-fivevh xl:text-lg lg:text-xs md:w-1/6 md:text-base p-1">
                    Total
                  </th>
                </tr>
              </thead>
                    ...
                    <tbody>
                      {standingsData.map((faculty, index) => (
                        <tr key={faculty.name}>
                          ...
                          <td className="px-2 py-2 border-2 md:border-4 border-black">
                            {faculty.gold}
                          </td>
                          <td className="px-2 py-2 border-2 md:border-4 border-black">
                            {faculty.silver}
                          ...
                          <td className="px-3 py-2 border-2 md:border-4 border-black">{`${
                    ...
                    <tbody>
                      {standingsData.map((faculty, index) => (
                        <tr key={faculty.name}>
                          ...
                          <td className="px-5 py-2 border-2 md:border-4 border-black">
