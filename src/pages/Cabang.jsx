...
const Cabang = () => {
  ...
  return (
    <>
        ...
        <div className="w-3/4 sm:w-3/5 md:w-full flex flex-col-reverse justify-center md:grid grid-cols-1 md:grid-cols-2 justify-items-center content-center mx-auto">
          ...
          <div className="m-auto flex flex-col mr-6 lg:mr-14 z-10">
            ...
            <div className="relative flex justify-center hover-trigger">
              <a
                href="https://bit.ly/RilisJadwalCaborTasen"
                target="__blank"
                className="bg-orange text-white font-universalserif px-3 py-1.5 lg:px-4 lg:py-2 xl:px-5 text-xs 425px:text-base sm:text-lg xl:text-2xl 2xl:text-2xl rounded-xl xl:rounded-2xl transform duration-200 transition-300 hover:scale-110 cursor-pointer"
              >
                Rundown
              </a>
      ...
      <div
        className="flex flex-col items-center justify-center bg-pattern-cabang"
